...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "A detailed overview of my professional background, including education, technical skills, and selected projects. You can also download a PDF version of my CV using the button above..",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-citizen-journal",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/abolfazl-shahsavari-5b7045284/?originalSubdomain=ir", "_blank");
        },
      },{
        id: 'social-telegram',
        title: 'telegram',
